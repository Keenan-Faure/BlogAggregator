...
func createRoutes() map[string]objects.Route {
	routes := map[string]objects.Route{
		...
		"GET /v1/bookmark": {
			Description: "Returns Bookmarked posts for a user",
			Supports:    []string{"GET"},
			Params: map[string]objects.Params{
				"page": {
					Key:   "page",
		...
		"GET /v1/liked": {
			Description: "Returns liked posts for a user",
			Supports:    []string{"GET"},
			Params: map[string]objects.Params{
				"page": {
					Key:   "page",
		...
		"GET /v1/bookmark_search": {
			Description:   "Searches for a Bookmark by title",
			Supports:      []string{"GET"},
			Params:        map[string]objects.Params{},
			AcceptsData:   false,
			Format:        []string{},
		...
		"GET /v1/liked_search": {
			Description:   "Searches for a Liked Post by title",
			Supports:      []string{"GET"},
			Params:        map[string]objects.Params{},
			AcceptsData:   false,
			Format:        []string{},
		...
		"POST /v1/bookmark": {
			...
			Params:        map[string]objects.Params{},
			AcceptsData:   true,
			Format:        objects.RequestBodyBookmark{},
			Authorization: "Authorization: ApiKey <key>",
		},
		"POST /v1/liked": {
			...
			Params:        map[string]objects.Params{},
			AcceptsData:   true,
			Format:        objects.RequestBodyLiked{},
			Authorization: "Authorization: ApiKey <key>",
		},
		...
		"DELETE /v1/bookmark/{PostID}": {
			Description:   "Removed the bookmark",
			Supports:      []string{"DELETE"},
			Params:        map[string]objects.Params{},
			AcceptsData:   false,
			Format:        []string{},
